...
public class Entity {
    ...
    public Component getComponentUntyped(Class<? extends Component> type) {
        return entityManager.getComponentUntyped(this, ComponentTypeManager.getTypeFor(type));
    }
     ...
     */
    public void delete() {
        System.out.println("Delete : " + EntityDebugger.getEntityString(this));
